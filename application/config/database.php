...
if(strstr($_SERVER['HTTP_HOST'], "toolbox.metro.ca")) 
{
	$db['default']['hostname'] = 'mysql:host=10.11.62.120';
	$db['default']['username'] = '';
	$db['default']['password'] = '';
	$db['default']['database'] = '';
}
else if(strstr($_SERVER['HTTP_HOST'], "staging.tgiprojects.com"))
{
	$db['default']['hostname'] = 'mysql:host=10.1.6.204';
	$db['default']['username'] = '';
	$db['default']['password'] = '';
	$db['default']['database'] = '';
}
