...
class Client extends MX_Controller
{
	...
	function editclient($client_id = 0)
	{
		...
		//if ($client_profile->client_id == $this->session->userdata('user_id'))  redirect('user');
		//if ($client_profile->user_permission <= $this->session->userdata('user_permission')) redirect('dashboard');
