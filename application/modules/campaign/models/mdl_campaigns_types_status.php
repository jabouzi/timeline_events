...
class Mdl_campaigns_types_status extends CI_Model
{
	...
	{
		$query = "SELECT campaigns_types_status.campaigns_types_status_id, campaigns_types_status.campaign_type_status_active, 
		campaigns_types_status.campaign_type_color, campaigns_i18n.i18n_name as campaign_type_name 
		FROM campaigns_types_status, campaigns_i18n, toolbox_languages
		WHERE campaigns_i18n.table_name = 'campaigns_types_status'
		AND campaigns_i18n.table_id = campaigns_types_status.campaigns_types_status_id
	...
	function i18n_site_query($lang)
	{
		...
		campaigns_types_status.campaign_type_color, campaigns_i18n.i18n_name as campaign_type_name 
		FROM campaigns_types_status, campaigns_i18n, toolbox_languages
		WHERE campaigns_types_status.campaign_types_status_active = '1'
	...
	{
		$query = "SELECT campaigns_types_status.campaigns_types_status_id, campaigns_types_status.campaigns_type_status_active, 
		campaigns_types_status.campaign_type_color, campaigns_i18n.i18n_name as campaign_type_name 
		FROM campaigns_types_status, campaigns_i18n, toolbox_languages
		WHERE campaigns_types_status.campaign_types_status_active = '1'
		AND campaigns_i18n.table_name = 'campaigns_types_status'
		...
		AND campaigns_i18n.language_id = toolbox_languages.language_id
		AND toolbox_languages.language_code = '{$lang}'
		AND campaigns_types_status.campaigns_types_status_id = '{$type_id}'";
		return $this->custom_query($query);
	}
}
