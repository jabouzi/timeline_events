...
<section>
	...
	<iframe src="<?php echo site_url('campaign/campaign_detail_print/'.$campaign_id.'/'.$this->session->userdata('current_site_lang')); ?>" style="position:absolute;left:-999999px;" frameBorder="0" width="100%" height="100%" name="frame"></iframe>
</section>
