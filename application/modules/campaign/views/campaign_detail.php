<div class="container">
	...
	<div class="title-top">
		...
		<div class="title-top-btns">
			...
			<a target="_blank" href="<?php echo site_url('campaign/campaign_detail_print/'.$campaign_id.'/'.$this->session->userdata('current_site_lang')); ?>" class="btn-icon-on-dark on-white">
